...
- Warm paper #f7f6f2, charcoal #282e2b, muted green #436653. Chinese headings use the self-hosted, page-subset Noto Serif SC variable font so desktop and mobile render the same letterforms; Georgia remains for the English wordmark and numerals, with system sans-serif body text. No third-party font requests, blue gradients, heavy shadows, or LT badge.
